...
const posts: BlogPost[] = [
  {
    ...
    title: "Xu hướng thời trang nam 2025 — Tối giản, bền vững",
    excerpt:
      "Năm 2025, thời trang nam hướng đến sự đơn giản, chất lượng và bền vững. Cùng tìm hiểu những xu hướng đáng chú ý.",
    date: "2025-01-20",
    image: "",
    tags: ["xu hướng", "2025", "bền vững"],
    content: `## 1. Quiet Luxury tiếp tục thống trị

Không logo lớn, không màu sắc chói. Thay vào đó là chất liệu cao cấp, đường may tinh tế, và form dáng hoàn hảo.

## 2. Earth Tone — tông màu đất

Nâu, kem, olive, xám đá — bảng màu lấy cảm hứng từ thiên nhiên chiếm ưu thế trong BST nam 2025.

## 3. Relaxed Tailoring

Blazer oversize nhẹ, quần ống rộng, áo polo thay thế áo sơ mi — công sở đang trở nên thoải mái hơn bao giờ hết.

## 4. Vải bền vững lên ngôi

Cotton hữu cơ, vải tái chế, linen — người tiêu dùng ngày càng quan tâm đến nguồn gốc chất liệu.

## 5. Capsule Wardrobe

Xu hướng xây dựng tủ đồ gọn nhẹ 20-30 item nhưng phối được hàng trăm outfit khác nhau đang phổ biến hơn bao giờ.`,
  },
  {
    slug: "phoi-do-nam-toi-gian",
    title: "Phối đồ nam tối giản — 5 nguyên tắc cơ bản",
    excerpt:
      "Tìm hiểu cách xây dựng tủ đồ tối giản nhưng vẫn đa dạng phong cách cho nam giới.",
    date: "2025-01-15",
    image: "",
...
Mỗi item nên phối được ít nhất 3 outfit khác nhau. Polo trắng → đi làm, đi chơi, đi café đều ổn.
